...
<div class="title-block">
    <h3 class="title">Outbox</h3>
    <p class="title-description">
        Add, update & delete outbox
    </p>
</div>
...
<script>
    $(document).ready(function () {
        $("#tbl_outbox_filter").prepend("<a href='<?= site_url('messages/view/-1') ?>' class='btn btn-primary pull-left'>New Message</a>");
        $("#tbl_outbox_filter input[type='search']").attr("placeholder", "Type your search here");
